...
<div class="max-w-6xl mx-auto pb-10">
    ...
    <div class="mb-8">
        <h2 class="text-2xl font-bold text-gray-800">Form Izin Pribadi (HOD)</h2>
        <p class="text-gray-500 mt-1">Isi data dengan benar. Izin Anda akan otomatis disetujui tanpa perlu persetujuan atasan.</p>
    </div>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div class="lg:col-span-2">
            <div class="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden relative hover:shadow-md transition-shadow">
                ...
                <form action="{{ route('hod.permit.store') }}" method="POST" class="p-8" x-data="{ permit_type: 'tugas' }">
                    @csrf
                    ...
                    <div class="flex items-center justify-between pt-6 border-t border-gray-100">
                        <a href="{{ route('hod.history') }}" class="text-sm font-bold text-gray-500 hover:text-gray-800 transition-colors bg-gray-100 px-5 py-2.5 rounded-xl">Batal</a>
                        <button type="submit" class="px-8 py-3 bg-gradient-to-r from-mna-dark to-mna-teal text-white font-bold rounded-xl shadow-lg shadow-mna-teal/30 hover:shadow-xl hover:-translate-y-0.5 transition-all flex items-center">
                            <i class="fa-solid fa-paper-plane mr-2"></i> Buat Izin
                        </button>
                    </div>
                ...
                <div class="relative pl-4 border-l-2 border-gray-100 space-y-8">
                    ...
                    <div class="relative">
                        ...
                        <div class="ml-4">
                            ...
                            <p class="text-xs text-gray-500 mt-1 leading-relaxed">Isi tanggal, keperluan, dan jam target.</p>
                        </div>
                    </div>

                    <div class="relative">
                        <span class="absolute -left-[21px] flex h-8 w-8 items-center justify-center rounded-full bg-mna-teal text-white ring-4 ring-white font-bold text-sm border border-gray-200">2</span>
                        <div class="ml-4">
                            <h4 class="text-sm font-bold text-gray-800">Langsung Disetujui</h4>
                            <p class="text-xs text-gray-500 mt-1 leading-relaxed">Sebagai HOD, izin Anda tidak memerlukan proses persetujuan dan otomatis <span class="text-green-600 font-bold">Approved</span>.</p>
                        </div>
                    </div>
                    ...
                    <div class="relative">
                        ...
                        <div class="ml-4">
                            ...
                            <p class="text-xs text-gray-400 mt-1 leading-relaxed">QR Code dan dokumen akan otomatis diterbitkan di halaman Riwayat.</p>
                        </div>
                    </div>
